...
> **Frozen historical record** of how `v0.1.0` was cut (the GO-061
> ceremony). Work-item IDs, key expiries, and version numbers are as of
> 2026-07 and are not maintained. The living, repeatable process is
