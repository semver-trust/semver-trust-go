## semver-trust completion

Generate the autocompletion script for the specified shell

### Synopsis

Generate the autocompletion script for semver-trust for the specified shell.
...
* [semver-trust completion bash](semver-trust_completion_bash.md)	 - Generate the autocompletion script for bash
